...
import hisocialImage from '../assets/hisocial.png';
import gajihubImage from '../assets/gajihub.png';
import dummyJsonImage from '../assets/dummyjson.png';
import orangeHrmImage from '../assets/orangehrm.png';
...
const Projects = ({ }: ProjectsProps) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: orangeHrmImage,
      tags: ['Python', 'Selenium', 'Pytest', 'Automation Testing'],
      github: '',
      demo: '',
      status: 'ongoing' as const,
    },
